export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8c29d5eaac65575f",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c2e769638f2c9b097daee2e0a9a363a7",
  ...
  USERS: [
    {
      ...
      id: "oGjNR57mHoU49Zb6hnVnuzY2Y8cQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "ZlH_LfM7FOwrGuy6HGKmJk24CvCb2CBcuKtOW8-ch-Y",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
